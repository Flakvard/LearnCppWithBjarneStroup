...
// Try this! Write a program that converts dollar to yen and dollar to kroner
    ...
    while (cin >> dollar >> conversion)
    {
        ...
        case 'k':
            ...
            cout << "$" << dollar << " dollars is in danish krones DKK "
                 << converted_value << ",-\n"; //print out the converted value
            break;
        
        case 'y':
            converted_value = dollar * dollar_to_yen; // assign the converted value of dollar to yen
            cout << "$" << dollar << " dollars is in japanese Yen JPY "
                 << converted_value << ",-\n"; //print out the converted value 
            break;

        default:
            cout << "ERROR: '"<<conversion<<"' is an invalid conversion unit,"
                 << "please write 'k' for danish kroner or 'y' for japanese yen\n"; //print out invalid units 
            break;
        }
    }
}